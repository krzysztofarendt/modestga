...
If you import modestga.examples, all examples will be run in a non-interactive mode (without interactive plots).
If you want to see the plots, run each file directly: python path_to_example.py
"""
